...
<?php $component->withAttributes([]); ?>
    <div class="container">
        <?php echo $__env->make('patient.book.partials.header', ['step' => 3], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <form id="bookingForm" method="POST" action="<?php echo e(route('patient.book.store.step.three')); ?>">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="appointment_time" id="appointment_time" required>
                        <div class="card">
                            <h3 class="h5 fw-bold mb-2">Select Date & Time</h3>
                            <p class="text-muted">Choose your preferred appointment slot for <?php echo e($booking['doctor']->name ?? 'your doctor'); ?>.</p>
        ...
        <div class="d-flex justify-content-between mt-4">
            <a href="<?php echo e(route('patient.book.create.step.two')); ?>" class="btn btn-secondary">← Back</a>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    let currentDate = new Date('<?php echo e($today->toDateString()); ?>');
    ...
    async function fetchAvailableSlots(date) {
        ...
        const doctorId = "<?php echo e($booking['doctor']->id); ?>";
...
<?php endif; ?><?php /**PATH C:\Users\User\OneDrive\Documents\Albert\Appointment-Booking-System-master\resources\views/patient/book/step-three.blade.php ENDPATH**/ ?>