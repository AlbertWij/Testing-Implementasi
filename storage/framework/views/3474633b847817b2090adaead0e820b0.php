    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            async function loadScheduleForDate(dateStr) {
                ...
                const response = await fetch(`<?php echo e(route('doctor.availability.schedule')); ?>?date=${dateStr}`);
            ...
            scheduleContainer.addEventListener('click', function (e) {
                ...
                if (e.target.matches('.unblock-btn')) {
                    if (confirm('Are you sure you want to make this time slot available?')) {
                        fetch('<?php echo e(route("doctor.availability.destroy")); ?>', {
                            method: 'DELETE',
                            headers: {
...
<?php endif; ?>
<?php /**PATH C:\Users\User\OneDrive\Documents\Albert\Appointment-Booking-System-master\resources\views/staff/doctor/availability.blade.php ENDPATH**/ ?>