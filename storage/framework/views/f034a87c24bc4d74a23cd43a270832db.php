...
<body class="d-flex align-items-center justify-content-center min-vh-100 p-3">
    <div class="card landing-card p-4 p-md-5 text-center w-100">
        ...
        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
            <a href="<?php echo e(route('login')); ?>" class="btn btn-primary btn-lg px-4 gap-3 btn-landing">
                Patient Portal
            </a>
            <a href="<?php echo e(route('staff.login')); ?>" class="btn btn-success btn-lg px-4 btn-landing">
                Staff Portal
            </a>
        </div>
    </div>
...
<?php /**PATH C:\Users\User\OneDrive\Documents\Albert\Appointment-Booking-System-master\resources\views/homepage.blade.php ENDPATH**/ ?>