...
<?php $component->withAttributes([]); ?>
   ...
   <div class="card mb-4">
    <form action="<?php echo e(route('admin.users.index')); ?>" method="GET">
        <div class="row g-3 align-items-end">
            <div class="col-md-5">
                ...
                <input type="text" name="search" id="search" class="form-control" placeholder="Search by name or email..." value="<?php echo e(request('search')); ?>">
            </div>
            <div class="col-md-4">
            ...
            <div class="col">
                <div class="card user-card h-100">
                    <div class="card-body text-center d-flex flex-column">
                        <span class="badge rounded-pill text-capitalize mb-2 align-self-center <?php switch($user->role): case ('patient'): ?> bg-primary-subtle text-primary-emphasis <?php break; ?> <?php case ('doctor'): ?> bg-info-subtle text-info-emphasis <?php break; ?> <?php case ('admin'): ?> bg-secondary-subtle text-secondary-emphasis <?php break; ?> <?php endswitch; ?>"><?php echo e($user->role); ?></span>
                        <h5 class="card-title fw-bold mt-2"><?php echo e($user->name); ?></h5>
                        <p class="card-text text-muted small"><?php echo e($user->email); ?></p>
                        <div class="mt-auto pt-3">
                            <button class="btn btn-sm btn-outline-secondary view-btn" data-user-id="<?php echo e($user->id); ?>" data-bs-toggle="modal" data-bs-target="#viewUserModal">View</button>
                            <button class="btn btn-sm btn-outline-primary edit-btn" data-user-id="<?php echo e($user->id); ?>" data-bs-toggle="modal" data-bs-target="#editUserModal">Edit</button>
                            <form action="<?php echo e(route('admin.users.destroy', $user)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Are you sure?');"><?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?><button type="submit" class="btn btn-sm btn-outline-danger">Delete</button></form>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="mt-4"><?php echo e($users->appends(request()->query())->links()); ?></div>
         ...
         <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content custom-modal-content">
                ...
                <div class="modal-body p-4">
                    <form action="<?php echo e(route('admin.users.store')); ?>" method="POST" x-data="{ role: 'patient' }">
                        <?php echo csrf_field(); ?>
                        <div class="row g-3">
...
<?php endif; ?><?php /**PATH C:\Users\User\OneDrive\Documents\Albert\Appointment-Booking-System-master\resources\views/admin/users/index.blade.php ENDPATH**/ ?>