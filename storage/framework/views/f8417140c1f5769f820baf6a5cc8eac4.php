...
<?php $component->withAttributes([]); ?>
    <header class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('patient.book.create.step.one')); ?>" class="btn btn-primary">+ Book Appointment</a>
    </header>

    <!-- Filter Bar -->
    <div class="card mb-4">
        <form action="<?php echo e(route('patient.appointments.index')); ?>" method="GET">
            <div class="row g-3 align-items-end">
                <div class="col-md-4"><label for="search" class="form-label">Search</label><input type="text" name="search" id="search" class="form-control" placeholder="Search by doctor or specialty..." value="<?php echo e(request('search')); ?>"></div>
                ...
                <div class="col-md-3"><label for="date_range" class="form-label">Date Range</label><select name="date_range" id="date_range" class="form-select"><option value="all">All Dates</option><option value="today">Today</option><option value="upcoming">Upcoming</option></select></div>
                 <div class="col-md-2">
                    <div class="d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('patient.appointments.index')); ?>" class="btn btn-light w-50">Clear</a>
                    </div>
                </div>
            </div>
        </form>
   ...
   <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 2000)" x-cloak>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="card" x-data="{ isEditing: false }">
            ...
            <div x-show="isEditing" x-cloak>
                ...
                <form action="<?php echo e(route('patient.appointments.update', $appointment)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
            ...
            <div x-show="!isEditing">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        <span class="badge rounded-pill <?php if($appointment->status == 'scheduled'): ?> bg-warning-subtle text-warning-emphasis <?php else: ?> bg-info-subtle text-info-emphasis <?php endif; ?> text-capitalize"><?php echo e($appointment->status); ?></span>
                        <span class="text-muted ms-2">ID: <?php echo e($appointment->id); ?></span>
                    </div>
                    ...
                    <div>
                        ...
                        <a href="<?php echo e(route('patient.appointments.export.patient', $appointment)); ?>" class="btn btn-outline-info btn-sm">Print</a>
                        <!-- UPDATED: Pass reason to the init function -->
                        <button @click="isEditing = true; initEditForm($event.target.closest('.card'), <?php echo e($appointment->doctor_id); ?>, '<?php echo e(\Carbon\Carbon::parse($appointment->appointment_date)->format('Y-m-d')); ?>', '<?php echo e(\Carbon\Carbon::parse($appointment->appointment_date)->format('H:i')); ?>', <?php echo e(json_encode($appointment->reason)); ?> )" class="btn btn-outline-primary btn-sm">Edit</button>
                        <form action="<?php echo e(route('patient.appointments.destroy', $appointment)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Are you sure?');">
                ...
                <hr>
                <div class="row">
                    <div class="col-md-4"><p class="mb-1 text-muted small">Doctor</p><h6 class="fw-bold"><?php echo e($appointment->doctor_name); ?></h6><p class="text-muted"><?php echo e($appointment->doctor_specialty); ?></p></div>
                    <div class="col-md-4"><p class="mb-1 text-muted small">Date</p><h6 class="fw-bold"><?php echo e(\Carbon\Carbon::parse($appointment->appointment_date)->format('Y-m-d')); ?></h6></div>
                    <div class="col-md-4"><p class="mb-1 text-muted small">Time</p><h6 class="fw-bold"><?php echo e(\Carbon\Carbon::parse($appointment->appointment_date)->format('h:i A')); ?></h6></div>
                </div>
            </div>
        </div>
    ...
    <script>
        async function fetchAvailableSlots(date, doctorId, timeSelectElement, originalTime = null) {
            ...
            let urlTemplate = "<?php echo e(route('patient.api.doctors.slots', ['doctor' => ':doctorId'])); ?>";
...
<?php endif; ?><?php /**PATH C:\Users\User\OneDrive\Documents\Albert\Appointment-Booking-System-master\resources\views/patient/manage-appointments.blade.php ENDPATH**/ ?>