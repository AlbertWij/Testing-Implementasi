...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback text-start"><?php echo e($message); ?></div> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
...
unset($__errorArgs, $__bag); ?>" id="password" placeholder="Password" required autocomplete="current-password">
...
unset($__errorArgs, $__bag); ?>
            ...
            <hr class="my-4">
            <p class="text-muted">Don't have an account? <a href="<?php echo e(route('staff.register')); ?>">Register</a></p>
...
</html><?php /**PATH C:\Users\User\OneDrive\Documents\Albert\Appointment-Booking-System-master\resources\views/staff/auth/login.blade.php ENDPATH**/ ?>