...
<body>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-shield-check" viewBox="0 0 16 16">
        <path d="M5.072 0a.5.5 0 0 0-.21.045l-4 2A.5.5 0 0 0 .5 2.5v5c0 3.493 2.918 6.907 7.26 9.29a.5.5 0 0 0 .48 0C12.582 14.407 15.5 10.993 15.5 7.5v-5a.5.5 0 0 0-.362-.455l-4-2A.5.5 0 0 0 11 0H5.072zM8 1.056 13.5 3.21v4.29c0 2.948-2.514 6.062-6 8.155C4.514 13.562 2 10.448 2 7.5V3.21L8 1.056zm3.854 4.646a.5.5 0 0 0-.708-.708L7.5 8.643 5.854 7a.5.5 0 1 0-.708.708l2 2a.5.5 0 0 0 .708 0l4-4z"/>
            ...
            <form method="POST" action="<?php echo e(route('staff.register')); ?>" x-data="{ role: 'doctor' }">
                <?php echo csrf_field(); ?>
                <div class="row g-3">
                    <div class="col-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="tel" name="phone_number" id="phone_number" class="form-control" value="<?php echo e(old('phone_number')); ?>" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="address" id="address" class="form-control" value="<?php echo e(old('address')); ?>" required>
                    </div>
                    ...
                    <div class="col-12" x-show="role === 'doctor'" x-transition x-cloak>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="specialty" id="specialty" class="form-control" value="<?php echo e(old('specialty')); ?>" placeholder="e.g., Cardiology, Pediatrics">
                            </div>
                            <div class="col-md-6">
                                <label for="license_number" class="form-label">License Number</label>
                                <input type="text" name="license_number" id="license_number" class="form-control" value="<?php echo e(old('license_number')); ?>">
                            </div>
                            <div class="col-md-6">
                                <label for="experience_years" class="form-label">Years of Experience</label>
                                <input type="number" name="experience_years" id="experience_years" class="form-control" value="<?php echo e(old('experience_years')); ?>">
                            </div>
                        </div>
                    </div>
            ...
            <div class="text-center mt-4">
                <p class="text-muted">Already have an account? <a href="<?php echo e(route('staff.login')); ?>">Sign In</a></p>
...
</html><?php /**PATH C:\Users\User\OneDrive\Documents\Albert\Appointment-Booking-System-master\resources\views/staff/auth/register.blade.php ENDPATH**/ ?>