...
<aside class="sidebar bg-white border-end offcanvas offcanvas-start" tabindex="-1" id="mainSidebar">
    ...
    <div class="offcanvas-body">
       <nav>
    <a href="<?php echo e(route('doctor.dashboard')); ?>" class="sidebar-link <?php echo e(request()->routeIs('doctor.dashboard') ? 'active' : ''); ?>">Dashboard</a>
    <a href="<?php echo e(route('doctor.appointments.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('doctor.appointments.index') ? 'active' : ''); ?>">My Appointments</a>
    <a href="<?php echo e(route('doctor.availability.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('doctor.availability.index') ? 'active' : ''); ?>">Manage Availability</a>
    <a href="<?php echo e(route('doctor.appointments.history')); ?>" class="sidebar-link <?php echo e(request()->routeIs('doctor.appointments.history') ? 'active' : ''); ?>">Appointment History</a>
    <a href="<?php echo e(route('doctor.profile.edit')); ?>" class="sidebar-link <?php echo e(request()->routeIs('doctor.profile.edit') ? 'active' : ''); ?>">My Profile</a>
    <hr>
...
</html><?php /**PATH C:\Users\User\OneDrive\Documents\Albert\Appointment-Booking-System-master\resources\views/components/layouts/doctor.blade.php ENDPATH**/ ?>