...
<?php $component->withAttributes([]); ?>
    <div class="mb-4">
        <h1 class="h2 fw-bold">Welcome, <?php echo e($doctor->name); ?>!</h1>
        <p class="text-muted">Manage your appointments and patient care.</p>
    </div>

    <div class="row g-4 mb-5">
        <div class="col-md-3"><div class="card"><h5>Total Appointments</h5><p class="fs-2 fw-bold mb-0"><?php echo e($stats['total']); ?></p></div></div>
        <div class="col-md-3"><div class="card"><h5>Upcoming</h5><p class="fs-2 fw-bold text-warning mb-0"><?php echo e($stats['upcoming']); ?></p></div></div>
        <div class="col-md-3"><div class="card"><h5>Completed</h5><p class="fs-2 fw-bold text-success mb-0"><?php echo e($stats['completed']); ?></p></div></div>
        <div class="col-md-3"><div class="card"><h5>Patients Today</h5><p class="fs-2 fw-bold text-info mb-0"><?php echo e($stats['patients_today']); ?></p></div></div>
    </div>
    ...
    <a href="<?php echo e(route('doctor.schedule.export.doctor')); ?>" class="btn btn-sm btn-outline-primary">
        Export Today's PDF
    </a>
</div>

        <p class="text-muted"><?php echo e(\Carbon\Carbon::today()->format('l, F j, Y')); ?></p>
        <div class="card">
            <?php $__empty_1 = true; $__currentLoopData = $todaysSchedule; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="d-flex justify-content-between align-items-center p-3 <?php if(!$loop->last): ?> border-bottom <?php endif; ?>">
                    <div>
                        <h6 class="fw-bold mb-1"><?php echo e(\Carbon\Carbon::parse($appointment->appointment_date)->format('h:i A')); ?></h6>
                        <p class="mb-0">Patient: <?php echo e($appointment->patient->name ?? 'N/A'); ?></p>
                    </div>
                    <div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        async function loadAppointmentsForDate(dateStr) {
            ...
            try {
                const response = await fetch(`<?php echo e(route('doctor.api.appointments.by_date')); ?>?date=${dateStr}`);
...
<?php endif; ?><?php /**PATH C:\Users\User\OneDrive\Documents\Albert\Appointment-Booking-System-master\resources\views/staff/doctor/dashboard.blade.php ENDPATH**/ ?>